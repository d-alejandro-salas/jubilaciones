    ...
    footer.innerHTML = `
      ...
      <div class="footer__container">
        ...
        <section id="mapa">
          ...
          <p>
            <span onclick="toggleMap()">Av. Santa Fe 1845</span><span id="verMapa" style="display:none;"> (hacé click para visualizar el mapa)</span>, Ciudad Autónoma de Buenos Aires.<br>(solo con cita previa)
          </p>
          <br>
